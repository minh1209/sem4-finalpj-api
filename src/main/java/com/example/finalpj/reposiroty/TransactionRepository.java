...
public interface TransactionRepository extends JpaRepository<Transaction, String> {
    List<Transaction> findAllBySongIdOrderByCreateAtDesc(String id);
    List<Transaction> findAllByCustomerIdOrderByCreateAtDesc(String id);
...
//    List<TransactionDAO> findAllByCustomerIdCustom(String id, Pageable pageable);
    List<Transaction> findAllByOrderByCreateAtDesc();
}
